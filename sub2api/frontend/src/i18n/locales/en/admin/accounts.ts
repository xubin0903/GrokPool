export default {
    accounts: {
      ...
      bulkActions: {
        ...
        deadToolsHint:
          'Grok dead-account tools: select accounts first, then probe. True dead accounts are auto-unschedulable and marked; flaky billing 403 is not treated as dead.',
        probeDeadConfirm:
          'Probe liveness for {count} selected account(s). Only permanent upstream bans / revoked credentials count as dead (billing 403 alone is NOT dead). Continue?',
        deleteDeadConfirm:
          'Probe {count} selected account(s) and permanently delete those classified as dead. This cannot be undone. Continue?',
        probeDeadSuccess: 'Probe done: alive {alive} / dead {dead} / unknown {unknown}',
        deleteDeadSuccess:
          'Deleted {deleted} dead account(s) (probe: alive {alive} / dead {dead} / unknown {unknown})',
        deleteDeadNone:
